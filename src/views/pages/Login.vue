                ...
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    <div class="text-center mb-8">
                        <div class="flex flex-col items-center ">
                            <img src="/demo/images/avatar.png" alt="Image" width="50" class="mb-3" style="border-radius: 50%;">
                        </div>
                        <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Welcome, Fauzan!</div>
                    ...
                    <div>
                        ...
                        <Password size="large" id="password1" v-model="password" placeholder="PIN" :toggleMask="true" class="w-full md:w-[30rem] mb-8" fluid :feedback="false" @keydown="handleEnter"></Password>
                        ...
                        <Message size="large" v-if="wrong" severity="error" class="mb-4">PIN salah!</Message>
                        <Button size="large" label="Sign In" class="w-full" @click="login"></Button>
                    </div>
                </div>
            </div>
        </div>
