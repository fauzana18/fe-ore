...
export function useLayout() {
    ...
    const executeDarkModeToggle = () => {
        layoutConfig.darkTheme = document.documentElement.classList.toggle('app-dark');
    ...
    const changeMenuMode = (event) => {
        ...
        localStorage.setItem('menuMode', event.value);
    ...
    const updateColors = (type, color) => {
        layoutConfig[type] = color.name;
        localStorage.setItem(type, color.name);
